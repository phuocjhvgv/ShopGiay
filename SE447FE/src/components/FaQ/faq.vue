        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 col-12">
                    <h1>
                        <span class="d-block text-danger" style='font-size: 80px; margin-left:50px;'>Your favorite
                            questions</span>
                        <span class="d-block text-dark" style='margin-left: 100px;font-size: 50px;'>and our answers to
                            them</span>
                    </h1>
                </div>
            </div>
                            ...
                            <div id="accordionGeneralOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="large-paragraph"><strong>Little Fashion</strong> is free Bootstrap 5
                                        website template for everyone. There are 8 HTML pages included in this template
                                        and you can expand more pages as you need.</p>
                            ...
                            <div id="accordionGeneralTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="large-paragraph"><a href="https://www.tooplate.com/free-templates"
                                        ...
                                        website templates for your business or personal use. Tooplate website has been
                                        online for almost 8 years now. Thank you for visiting our website.</p>
                                </div>
                            </div>
                        </div>
